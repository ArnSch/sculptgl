define([
  ...
  function SculptGL() {
    ...
    this.drawSelectOverRtt_ = true; // only render the select circle
  }
  ...
  SculptGL.prototype = {
    ...
    /** Request a render */
    render: function (drawSelectOverRtt) {
      if (this.drawSelectOverRtt_)
        this.drawSelectOverRtt_ = drawSelectOverRtt;
